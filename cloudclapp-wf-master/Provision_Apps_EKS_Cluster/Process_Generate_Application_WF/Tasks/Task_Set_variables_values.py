...
def form_app_file(work_directory, app_name, app_image, app_port, app_replicas, app_node_port):
    ...
    with open(app_file) as f:
    	...
    	newText = newText.replace('app_lb_name', app_name+"_lb_name")
    	newText = newText.replace('app_service_elb', app_name+"_service_elb")
    	newText = newText.replace('app_load_balancer_name', app_name+"_load_balancer_name")
    	newText = newText.replace('app_load_balancer_hostname', app_name+"_load_balancer_hostname")
    	newText = newText.replace('app_load_balancer_info', app_name+"_load_balancer_info")
