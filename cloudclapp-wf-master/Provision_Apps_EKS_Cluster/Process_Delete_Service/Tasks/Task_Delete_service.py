...
if __name__ == "__main__":
    if 'terraform_provision_app_workspace' in context:
        ...
        Orchestration.update_asynchronous_task_details(*async_update_list, f'Romeving EKS cluster terraform workspace ...')
        ...
        if os.path.exists(terraform_provision_app_workspace):
            destination = shutil.rmtree(terraform_provision_app_workspace)
        
        Orchestration.update_asynchronous_task_details(*async_update_list, f'Romeving EKS cluster terraform workspace ...OK')
