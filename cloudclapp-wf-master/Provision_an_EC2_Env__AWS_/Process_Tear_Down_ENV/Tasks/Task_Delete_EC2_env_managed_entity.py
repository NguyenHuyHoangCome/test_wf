...
if context.get('is_cluster_created') == False:
...
if __name__ == "__main__":
    ...
    #get device id.
    device_ref = context.get('ec2_vpc_me_ext_ref')
    ...
    MSA_API.task_success('The EC2 managed entity with ' + 'id=' + device_id + ' is deleted.', context)