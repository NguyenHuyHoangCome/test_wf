...
dev_var = Variables()
dev_var.add('target', var_type='String')
dev_var.add('alerts_json_file', var_type='Link')
dev_var.add('total_alerts', var_type='Integer')
dev_var.add('info_count', var_type='Integer')
dev_var.add('low_count', var_type='Integer')
dev_var.add('medium_count', var_type='Integer')
dev_var.add('high_count', var_type='Integer')
