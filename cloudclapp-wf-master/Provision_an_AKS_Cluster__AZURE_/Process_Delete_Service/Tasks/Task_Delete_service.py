...
if __name__ == "__main__":
    if 'msa_dev_terraform_provision_aks_cluster_workspace' in context:
        ...
        terraform_provision_aks_cluster_workspace = context.get('msa_dev_terraform_provision_aks_cluster_workspace')
