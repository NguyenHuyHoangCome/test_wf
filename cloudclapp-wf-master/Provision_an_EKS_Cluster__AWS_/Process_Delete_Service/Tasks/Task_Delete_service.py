...
if __name__ == "__main__":
    if 'terraform_provision_eks_cluster_workspace' in context:
        ...
        #Get the terraform EKS provisioning workspace
        terraform_provision_eks_cluster_workspace = context.get('terraform_provision_eks_cluster_workspace')
        #Check if the infrastructure was already copied to the dest.
        if os.path.exists(terraform_provision_eks_cluster_workspace):
            destination = shutil.rmtree(terraform_provision_eks_cluster_workspace)
