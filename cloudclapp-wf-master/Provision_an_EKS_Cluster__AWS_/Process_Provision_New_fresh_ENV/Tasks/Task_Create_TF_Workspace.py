...
TF_CONF_TEMPLATE = '/opt/fmc_repository/Process/cloudclapp-wf/Terraform_Configuration_Templates/Infrastructures/Catalogs/eks/terraform-provision-eks-cluster'
...
if __name__ == "__main__":
    ...
    terraform_provision_eks_cluster_workspace = dest
    context.update(terraform_provision_eks_cluster_workspace=terraform_provision_eks_cluster_workspace)
