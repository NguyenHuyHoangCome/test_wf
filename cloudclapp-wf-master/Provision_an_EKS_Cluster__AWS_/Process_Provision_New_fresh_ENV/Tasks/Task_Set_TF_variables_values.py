...
if __name__ == "__main__":
    ...
    ftvars_filename = terraform_provision_eks_cluster_workspace +"/"+ TERRAFORM_TFVARS_FILENAME
    ...
    eks_file = terraform_provision_eks_cluster_workspace+"/eks-cluster.tf"
    
    replace(eks_file, "#CLOUDCLAPP_TAGS", tag_content)
