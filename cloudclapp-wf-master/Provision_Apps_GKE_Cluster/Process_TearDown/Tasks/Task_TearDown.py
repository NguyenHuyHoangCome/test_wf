...
def gcloud_authenticate(service_account_key_file_path):
...
if __name__ == "__main__":
    ...
    if not os.path.exists(work_directory+"/terraform.tfstate"):
    	...
    	context.update(is_deployment_created=False)
    	MSA_API.task_success('No deployment Created, Clearing Internal Entities', context)
    	sys.exit()
    ...
    gcloud_authenticate(service_account_key_file_path)
