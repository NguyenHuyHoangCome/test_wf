...
TF_CONF_TEMPLATE = '/opt/fmc_repository/Process/cloudclapp-wf/Terraform_Configuration_Templates/Applications/Catalogs/azure/terraform_provision_apps_aks_cluster'
